    ...
    def build(self, date: Optional[str] = None, *, daemon_state_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        report = {
            ...
            "completed_work": {
                ...
                "pending_outcome_verification_count": growth.get("pending_outcome_verification_count", 0),
