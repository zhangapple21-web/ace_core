...
因此，任何推票结果都必须同时包含候选分析和“小妍小群话术”。小妍只转述老师已确认的同一快照，不自行补充行情、资金、催化或买入结论；快照过期、窗口已过或老师未确认时，话术应明确写“等回踩/等下一结构”，不得漏掉小群表达层。

收盘复盘不是固定脚本，而是 ACE 的日常自我学习：把盘前判断、盘中实际和收盘结果对照，检查市场情绪、主线宽度、核心/跟风、位置、预期差、分时承接、量价、资金与退出路径；记录判断被验证/被打脸之处及“如果重来一次是否还选”，形成带证据的经验候选，下一日重新验证，不能因一次结果机械改写永久规则。
